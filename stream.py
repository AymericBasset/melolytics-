...
if virus_file and astrocyte_file:
    ...
    if st.sidebar.button('Estimate Density'):
        ...
        segmented_astrocytes = detect_and_segment_astrocyte_bodies(
        ...
        features_df_knn = analyze_astrocyte_aggregation_knn(
        ...
        features_df_density = analyze_astrocyte_aggregation_knn_density(
            segmented_astrocytes)
